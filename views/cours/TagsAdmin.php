            ...
            <div class="w-full overflow-x-auto bg-white rounded-lg shadow">
                <section>
                    <div class="p-4 border-b border-gray-200">
                        <h2 class="text-xl font-semibold text-gray-800">Liste des Tags</h2>
                    </div>
                    ...
                    require_once PROJECT_ROOT . '\src\controllers\TagsController.php';
                    $courses = new TagsController();

                    //    $courses->read();


                    foreach ($courses->getAllTags() as $course): ?>
