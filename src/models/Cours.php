...
class Cours extends DaoGenerator {
    ...
    public function setContenue($contenue): void { $this->contenue = $contenue; }
    ...
    public function getEtudiants(): array { return $this->etudiants; }
    public function setEtudiants(array $etudiants): void { $this->etudiants = $etudiants; }
